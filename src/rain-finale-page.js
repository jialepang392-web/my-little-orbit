...
try{
  let timeout;
  const load=Promise.all([import('./rain-finale/viewer.js?v=0121'),fetch('./assets/rain-finale/title-glyphs.json').then(r=>{if(!r.ok)throw new Error('Title outlines missing');return r.json();})]);
