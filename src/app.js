...
import { addDiscovery, readProgress, writeProgress } from './storage.js?v=0121';
import { escapeHtml, renderMarkdown } from './markdown.js?v=0121';
import { downloadPostcard } from './postcard.js?v=0121';
import { artImage } from './art-paths.js?v=0121';
import { iconSvg } from './illustrations.js?v=0121';
...
async function bootWorld(){
  ...
  try{
    const module=await Promise.race([import('./world.js?v=0121'),new Promise((_,reject)=>{timeout=setTimeout(()=>reject(new Error('3D 依赖下载超时，文章仍可阅读。')),15000);})]);
