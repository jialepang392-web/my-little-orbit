...
import { addDiscovery, readProgress, writeProgress } from './storage.js?v=0122';
import { escapeHtml, renderMarkdown } from './markdown.js?v=0122';
import { downloadPostcard } from './postcard.js?v=0122';
import { artImage } from './art-paths.js?v=0122';
import { iconSvg } from './illustrations.js?v=0122';
...
async function bootWorld(){
  ...
  try{
    const module=await Promise.race([import('./world.js?v=0122'),new Promise((_,reject)=>{timeout=setTimeout(()=>reject(new Error('3D 依赖下载超时，文章仍可阅读。')),15000);})]);
